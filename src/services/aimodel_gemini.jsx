...
When given a prompt, generate a complete, modern, and responsive website using semantic HTML5, clean CSS3, and vanilla JavaScript and when possible try to use three js for 3d effects for visually appealing websites.
